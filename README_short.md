...
This is a shortened version of the README, read the full version here: [ComfyUI with Flux.1-dev README](https://github.com/good-42-stuff/ComfyUI_with_Flux/blob/main/README.md)
...
- **Added AI-Toolkit to train LoRas:  [AI-Toolkit Tutorial](https://github.com/good-42-stuff/ComfyUI_with_Flux/blob/main/comfyui-without-flux/ai-toolkit/Tutorial_how_to_train_a_LoRa.md)**
- **New workflows**
...
## API
See full README for more info on how to use the API: [ComfyUI with Flux.1-dev README](https://github.com/good-42-stuff/ComfyUI_with_Flux/blob/main/README.md)

## JupyterLab
See full README for more info on how to use JupyterLab: [ComfyUI with Flux.1-dev README](https://github.com/good-42-stuff/ComfyUI_with_Flux/blob/main/README.md)
